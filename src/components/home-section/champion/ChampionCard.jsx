...
const ChampionCard = (props) => {
  ...
  const onClick=()=>{
    ...
    const videoUrl = `https://youtobe.com/embed/${item.video}`
    document.querySelector(`#champ-detail-${props.id} iframe`).setAttribute('src', `https://youtube.com/embed/${item.video}`)
  ...
  return (
    <div className='champion-card' ref={cardRef}  >
        <div className="frame">
            <div className="bg-image overlay bg" style={{backgroundImage: `url(${item.bg})`}} onClick={onClick} ></div>
        </div>
